const assetDir = "assets_2026-03-13_v008";

const routes = {
  home: "index_2026-03-13_v008.html",
  about: "about_2026-03-13_v008.html",
  contact: "contact_2026-03-13_v008.html",
  partners: "partners_2026-03-13_v008.html",
  stations: "stations_2026-03-13_v008.html",
  services: "services_2026-03-13_v008.html",
  products: "products_2026-03-13_v008.html",
  resources: "resources_2026-03-13_v008.html",
  productCtcsystem: "product-ctcsystem_2026-03-13_v008.html",
  productConsumables: "product-consumables_2026-03-13_v008.html",
  productMag: "product-mag_2026-03-13_v008.html",
  productFloraup: "product-floraup_2026-03-13_v008.html",
  productFlora8: "product-flora8_2026-03-13_v008.html",
  productFloraz: "product-floraz_2026-03-13_v008.html",
  productFlorac: "product-florac_2026-03-13_v008.html",
  productFlorag: "product-florag_2026-03-13_v008.html",
  productFiberup: "product-fiberup_2026-03-13_v008.html"
};
...
function buildHeader(currentPage) {
  const nav = navItems
    .map(
      ([key, label]) =>
        `<li><a class="nav__link" href="${routes[key]}"${key === currentPage ? ' aria-current="page"' : ""}>${label}</a></li>`
    )
    .join("");
  ...
  return `
    <header class="page-header">
      <div class="container page-header__inner">
        <a class="brand" href="${routes.home}" aria-label="榮文生醫首頁">
          <img class="brand__logo" src="${asset("brand_logo_top_2026-03-13_v008.png")}" alt="榮文生醫 Good Future BioMed" />
        </a>
      ...
      (group) => `
        <div>
          ...
          <ul class="footer__list">
            ${group.links.map(([key, label]) => `<li><a href="${routes[key]}">${label}</a></li>`).join("")}
          </ul>
        </div>
      `
    )
      ...
      <div class="container">
        <div class="footer__grid">
          <div class="footer__brand">
            <img class="footer__brand-logo" src="${asset("brand_logo_bottom_2026-03-13_v008.png")}" alt="榮文生醫 Good Future BioMed" />
...
function initContactComposer() {
  ...
  const button = document.querySelector("[data-contact-compose]");
  ...
  button.addEventListener("click", () => {
    ...
    if (!subject || !message) {
      ...
      status.textContent = "請至少填寫主題與內容，方便榮文生醫更快了解您的需求。";
      return;
    }
    ...
    status.textContent = "已為您整理寄信內容；若未自動開啟 Email，用戶端請直接寄信至 info@gfmed.cc。";

    window.location.href = `mailto:info@gfmed.cc?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(bodyLines.join("\n"))}`;
  });
}
